...
public :
    ...
    computing_device(processor _processor, float _ram_capacity) {
        cpu = _processor;
...
public :
    ...
    void print(){
        ...
        computing_device compute_device(cpu, ram_capacity);
        cout << name << " has [" << compute_device.processing_power() << "] power with [" << input.name << "] input" << endl;
    }
};
...
public :
    ...
    void print(){
        ...
        computing_device compute_device(cpu, ram_capacity);
        cout << name << " using [" << os << "] with [" << network << "] network and running at [" << compute_device.processing_power() << "] power" << endl;
    }
};
